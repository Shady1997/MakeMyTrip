...
public class TestBase {
	...
	public void prepareClassProperties(String browser) throws IOException, AWTException {
		...
		loginPage = new HomePage_Flight(driver);
	}

	@Test(priority = 1, groups = "smoke", description = "Start Make-My-Trib Web Application")
	public void startApplication() throws InterruptedException {
		...
		PageBase.assertToObjectExistWithGetText(driver, "Make My Trip");
	}
